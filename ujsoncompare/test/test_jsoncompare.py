...
class TestJSONCompare(unittest.TestCase):
    ...
    def test_list_of_hashes(self):
        ...
        self.assertTrue(ujsoncompare.are_same(a, b)[0])
    ...
    def test_list_of_hashes_unordered(self):
        ...
        self.assertTrue(ujsoncompare.are_same(a, b, True)[0])
    ...
    def test_list_of_hashes_unordered_fail(self):
        ...
        self.assertFalse(ujsoncompare.are_same(a, b)[0])
    ...
    def test_list_of_hashes_ignore_key(self):
        ...
        self.assertTrue(ujsoncompare.are_same(a, b, True, ["wtf2"])[0])
    ...
    def test_inner_val_sensitivity_false(self):
        ...
        self.assertFalse(ujsoncompare.are_same(a, b, True)[0])
    ...
    def test_giant_json_ignores_reordering(self):
        ...
        self.assertTrue(ujsoncompare.json_are_same(a, b, True)[0])

    def test_giant_json_finds_reordering(self):
        a = open("testing-data/jsonbloba.json").read()
        b = open("testing-data/jsonblobb.json").read()
        self.assertFalse(ujsoncompare.json_are_same(a, b)[0])
    ...
    def test_contains_same_size(self):
        ...
        self.assertTrue(ujsoncompare.contains(expected, actual)[0])
        # same, error_message = ujsoncompare.contains(expected, actual)
    ...
    def test_contains_same_size2(self):
        ...
        self.assertTrue(ujsoncompare.contains(expected, actual, True)[0])
    ...
    def test_contains_same_size3(self):
        ...
        self.assertFalse(ujsoncompare.contains(expected, actual)[0])
        # same, error_message = ujsoncompare.contains(expected, actual)
        # assert same, error_message
